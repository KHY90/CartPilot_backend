"""
캐시 서비스
인메모리 캐싱 (Redis 코드는 주석 처리됨 - 필요시 활성화 가능)
"""
import asyncio
import hashlib
import json
...
class RedisCache:
    ...
    def __init__(self) -> None:
        ...
        # Redis 비활성화 - 인메모리 캐시만 사용
        self._use_fallback = True
        logger.info("캐시 초기화: 인메모리 모드로 동작")

    async def _get_redis(self):
        """Redis 연결 가져오기 (lazy initialization)"""
        # Redis 비활성화 - 항상 인메모리 캐시 사용
        return None
